...
| 71 | Queensland Liquor Act bars advertising drink prices, discounts or happy hours outside the venue, and a social post counts | `social` industry rules, P5 | 2026-09-24 | A via snippet, see notes/social-research/07 |
| 72 | ABAC: nobody who is or looks under 25 in alcohol marketing; alcohol content only where under-18s can be kept out | `social` industry rules | 2026-09-24 | Under-25 from training knowledge, unverified; 18+ rule A via snippet |
| 73 | QBCC: licence number and licensed name in all advertising, and a company Facebook page counts as advertising | `social` industry rules | 2026-09-24 | A via snippet |
| 74 | Google bans offering incentives for reviews, even to genuine customers | `social` Before anything goes out | 2026-09-24 | A, Google contribution policy, reported by the ChatGPT deep research run |
